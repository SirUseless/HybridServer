...
public class XMLHelper {
	...
	public static String transformWithXSLTfromURI(String xmlURI, String xsltURI)
			throws MalformedURLException, IOException, TransformerException {
		HttpURLConnection xmlConn = (HttpURLConnection) new URL(xmlURI)
				.openConnection();
		InputStream isXml = xmlConn.getInputStream();

		HttpURLConnection xsltConn = (HttpURLConnection) new URL(xsltURI)
				.openConnection();
	...
	public static boolean checkWithXSDFromURI(String xmlURI, String xsdURI)
		...
		try{
			...
			HttpURLConnection xml = (HttpURLConnection) new URL(xmlURI)
					.openConnection();
